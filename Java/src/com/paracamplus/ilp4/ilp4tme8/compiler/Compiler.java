...
public class Compiler extends com.paracamplus.ilp4.compiler.Compiler
    ...
    public Void visit(IASTwriteProperty iast, Context context) throws CompilationException {
        ...
        IASTvariable tmProperty = context.newTemporaryVariable();
        emit("  ILP_Object " + tmProperty.getMangledName() + "; \n");
        Context cProperty = context.redirect(new AssignDestination(tmProperty));
        ...
        emit(tmProperty.getMangledName());
        emit(", ");
